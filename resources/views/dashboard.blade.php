...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="dropdown">
            ...
            <button
                class="btn btn-sm position-relative shadow-sm rounded-circle notification-btn
                {{ $noLeidas > 0 ? 'btn-danger notification-alert' : 'btn-outline-secondary' }}"
                type="button"
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-primary h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/usuarios" class="btn btn-light btn-sm">
                            Gestionar
                        </a>
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-secondary h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Áreas del sistema (Sistemas, Marketing, etc.)
                        </p>

                        <a href="/admin/roles" class="btn btn-light btn-sm">
                            Gestionar
                        </a>
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-dark h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Administrar marcas registradas
                        </p>

                        <a href="/admin/marcas" class="btn btn-light btn-sm">
                            Gestionar
                        </a>
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-warning h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Categorías de tickets por área
                        </p>
            ...
            <div class="col-md-4">
                ...
                <div class="card bg-danger-subtle h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Subcategorías por categoría creada
                        </p>
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-white h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Ver y supervisar todos los tickets
                        </p>
    ...
    {{-- =========================================================
        SOLICITANTES
        Unidad + Administración y Finanzas + cualquier otro
        tipo_acceso = solicitante
    ========================================================== --}}
    ...
    {{-- =========================================================
        ÁREAS QUE ATIENDEN TICKETS
        Sistemas, Marketing, etc.
        tipo_acceso = gestion
    ========================================================== --}}
    @if(session('tipo_acceso') === 'gestion')
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-primary h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Tickets dirigidos a otras áreas
                        </p>

                        <a
                            href="/tickets/entre-areas"
                            class="btn btn-light btn-sm"
                        >
                            Ver
                        </a>
